...
**der Spielercharakter** — Menschin, Bürgerin, Krämerin 1, Silber 1. Motivation: Schulden des Vaters.
...
**ein Händler Tuchhändler** — Silber 1. Feilschen 50, Charme 38, Besonnenheit 36, Wahrnehmung 33. Startpreis 6 S.

**ein Schläger Raufbold** — Messing 2. KG 38, Ausweichen 33, ST 35 (STB 3), WI 32 (WIB 3), I 30, LP 11, waffenlos.

**Dieb (Event)** — Fingerfertigkeit 45. Kein voller Bogen.

Vorbereitete Events: sozialer Misserfolg am Stand → Taschendieb; `gehen` in die Gasse → ein Schläger; nach Bindung Wache naht.
