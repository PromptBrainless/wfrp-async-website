...
4. [knowledge/00-INDEX.md](knowledge/00-INDEX.md) — wenn du suchst
5. Dann den Weg, den du gehst — nicht alle Dateien hintereinander

Wege: [Abend](knowledge/10-system/16-kampagne-1.md) · [Spiel](knowledge/10-system/00-das-spiel.md) · [Drosselau](knowledge/07-reikland/drosselau/README.md) · [Übergabe](knowledge/00-UEBERGABE.md) · [Skill](skill/SKILL.md)
