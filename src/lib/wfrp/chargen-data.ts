...
export const CAREERS: CareerDef[] = [
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(28, 30), zwerg: r(35, 36), halbling: r(34, 36), hochelf: null, waldelf: null },
    stage1: {
      name: "Jungspund",
      status: { tier: "messing", rank: 2 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(31, 32), zwerg: r(37, 38), halbling: r(37), hochelf: r(30), waldelf: null },
    stage1: {
      name: "Deckratte",
      status: { tier: "silber", rank: 1 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(33, 34), zwerg: null, halbling: r(38), hochelf: null, waldelf: null },
    stage1: {
      name: "Flussrekrut",
      status: { tier: "silber", rank: 1 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(35), zwerg: r(39), halbling: r(39), hochelf: null, waldelf: null },
    stage1: {
      name: "Flusskundiger",
      status: { tier: "messing", rank: 4 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(36, 37), zwerg: r(40), halbling: r(40), hochelf: r(31, 45), waldelf: null },
    stage1: {
      name: "Landratte",
      status: { tier: "silber", rank: 1 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(38), zwerg: r(41, 42), halbling: r(41, 44), hochelf: r(46), waldelf: null },
    stage1: {
      name: "Flussstrolch",
      status: { tier: "messing", rank: 2 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(39, 40), zwerg: r(43, 44), halbling: r(45, 47), hochelf: null, waldelf: null },
    stage1: {
      name: "Dockarbeiter",
      status: { tier: "messing", rank: 3 },
  ...
  },
  {
    ...
    klasse: "flussvolk",
    complete: true,
    ranges: { mensch: r(41), zwerg: r(45), halbling: null, hochelf: null, waldelf: r(11) },
    stage1: {
