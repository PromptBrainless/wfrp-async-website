...
UI: list[tuple[str, str, str, str, str, str]] = [
    ...
    ("T-031", "Frist", "wenn alle Absichten da sind", "src/components/game/FristBand.tsx", "alle-liegen", "Alle Absichten liegen."),
    ...
    ("T-052", "Faden", "Filter Intention", "src/components/game/Leben.tsx", "filter-intent", "Intention"),
    ...
    ("T-058", "Faden", "leer, Szene offen", "src/components/game/Leben.tsx", "leer-offen", "Noch kein Beat. Die Szene wartet."),
    ("T-059", "Faden", "leer, Szene zu, SL", "src/components/game/Leben.tsx", "leer-zu-sl", "Szene zu. Öffne eine Gasse im Pult."),
    (
        "T-060",
        "Faden",
    ...
    ("T-126", "Kartenleiste", "Button senden", "src/components/game/IntentBar.tsx", "senden", "Intention senden"),
